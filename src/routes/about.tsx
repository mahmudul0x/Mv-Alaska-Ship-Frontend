  ...
  head: () => ({
    meta: [
      { title: "About MV Alaska — Bangladesh's Most Luxurious Cruise" },
      {
        name: "description",
        content:
          "The story behind MV Alaska — the largest government-approved luxury cruise ship operating in the Sundarbans.",
      },
    ],
  }),
});
  ...
  return (
    <>
        ...
        <div className="container-luxe grid lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7 space-y-6 text-muted-foreground leading-relaxed text-lg">
            <p>
              ...
              of comfort, or comfort at the cost of the wild. M.V. Alaska was built to retire that
      ...
      {/* ── Company & registration ──
          Published because the payment gateway's merchant review requires a
          verifiable legal identity on the site — and because a customer about
          to send money to strangers is entitled to know who they are. */}
      <section className="py-20 md:py-24 bg-background border-t border-border">
        <div className="container-luxe max-w-4xl">
          <div className="text-center eyebrow text-gold-text mb-3">Know more</div>
          <h2 className="text-center font-display text-3xl md:text-4xl font-light mb-4">
            About our company
          </h2>
          <p className="text-center text-sm text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            {COMPANY.name} is a licensed Bangladeshi tour operator running government-approved
            cruises into the Sundarbans. All bookings and payments on this website are made directly
            with us.
          </p>
      ...
      <section className="py-28 md:py-36 gradient-ocean">
        <div className="container-luxe grid lg:grid-cols-2 gap-12 items-center">
          <img
            src={canal}
            alt="M.V. Alaska in the Sundarbans"
